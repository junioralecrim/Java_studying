...
import com.example.chacklistapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createConection(){
        try{
            ...
            Toast.makeText(this.getApplicationContext(), "Conecção do banco feita com sucesso", Toast.LENGTH_SHORT).show();
        }catch(Exception e){
